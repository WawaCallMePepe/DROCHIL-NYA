...
text2 = "Минет и сперма; Великовозрастное; Растреляли; Pussy; Повторили!; Анальное расследование; Немецкое; Групповая оргия; " \
        "Танковое сражение на анальных просторах."
text3 = "axaxaxaxaxaxaxxaa"

# [text, font_size, color, line_width, x_cord]
content = [[text1, 23, "#aa0000", 32, 20],
           [text2, 20, "#000000", 38, 25],
           [text3, 15, "#000000", 20, 450 - (ImageFont.truetype("main_font.ttf", 15).getsize(text3)[0])]]
